...
@RestController
@RequestMapping(AdminModelRestController.REST_URL)
public class AdminModelRestController extends AbstractModelController{

    static final String REST_URL = "/rest/admin/models";
