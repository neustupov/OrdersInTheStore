...
@RestController
@RequestMapping(AdminTypeRestController.REST_URL)
public class AdminTypeRestController extends AbstractTypeController{

    static final String REST_URL = "/rest/admin/types";
